...
mixin _$ChildInputState {
  ...
  FormControl<String>? get nameController =>
      throw _privateConstructorUsedError; //    FormControl<Gender?>? genderController,
...
//    FormControl<Gender?>? genderController,
  ...
  @override
  String toString() {
    return 'ChildInputState(inputData: $inputData, isShowGenderValidateMessage: $isShowGenderValidateMessage, nameController: $nameController, birthdayController: $birthdayController)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, inputData,
      isShowGenderValidateMessage, nameController, birthdayController);
...
abstract class _ChildInputState implements ChildInputState {
  ...
  FormControl<String>? get nameController;
  @override //    FormControl<Gender?>? genderController,
  FormControl<String>? get birthdayController;
  @override
  @JsonKey(ignore: true)
  _$$_ChildInputStateCopyWith<_$_ChildInputState> get copyWith =>
...
mixin _$ChildInputData {
  /// 名前（ニックネーム）
  String get name => throw _privateConstructorUsedError; // /// 性別
// Gender? gender,
  /// 出産予定日
